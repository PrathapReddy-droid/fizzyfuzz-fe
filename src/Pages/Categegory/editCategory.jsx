...
const EditCategory = () => {
    ...
    useEffect(() => {
        ...
        fetchDataFromApi(`/api/category/${id}`).then((res) => {
            ...
            // Hydrate through setFormFields (rather than mutating formFields
            // directly) so the name field and the FSSAI switch both reliably
            // reflect the loaded category as soon as the response arrives.
            setFormFields(prev => ({
                ...prev,
                name: res?.category?.name || "",
                isFssaiRequired: !!res?.category?.isFssaiRequired,
            }));
