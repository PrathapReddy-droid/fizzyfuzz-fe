...
export const Products = () => {
  ...
  onClick={() => {
    ...
    // ✅ Open modal if profile is complete
                                ...
                                isLoading === false ? productData?.products?.length !== 0 && productData?.products?.map((product, index) => {
                                    return (
                                        <TableRow key={index} className={product.checked === true ? '!bg-[#1976d21f]' : ''}>
                                            ...
                                            <TableCell style={{ minWidth: columns.minWidth }}>
                                                <p className={`rounded ${product?.status=="APPROVED"?"bg-green-600":(product?.status=="PENDING"?"bg-orange-600":"bg-red-600")}  text-white text-center p-1`}>
                                                    {product?.status}
                                                </p>
                                            </TableCell>
